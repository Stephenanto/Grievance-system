<%@ Page Title="" Language="C#" MasterPageFile="~/login/forget.master" AutoEventWireup="true" CodeFile="forgetpassword.aspx.cs" Inherits="login_forgetpassword" %>
...
<script runat="server">
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from student_register where email = @email", con);
