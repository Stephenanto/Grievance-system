<%@ Page Language="C#" AutoEventWireup="true" CodeFile="laptechLoginPage.aspx.cs" Inherits="login_laptechLoginPage" %>
   ...
   <div class="container">
	  ...
	  <div class="row" id="marquee">
        ...
        <div class="row">
			...
			<div class="col-md-6">
				<div class="row" id="side2">
					<div class="row">
						<img alt="" src="images/keys.png" id="key">Lab Techinicians Login Page
					</div>
                    <div class="row">
						<form id="Form1" role="form" runat="server">
							...
							<div class="checkbox">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn btn-primary" OnClick="Button1_Click" />     
                                  ...
                                  <a href="forgetPasswordLab.aspx">forgot Password....?</a> <a href="../index.aspx" >Home</a>
        ...
        <asp:SqlDataSource ID="dsLogin" runat="server" ConnectionString="<%$ ConnectionStrings:examConnectionString %>"
            SelectCommand="select * from laptech_register where  username = @lname and password = @pwd">
            <SelectParameters>
