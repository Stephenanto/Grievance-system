<%@ Page Title="" Language="C#" MasterPageFile="~/login/staffHomeMaster.master" AutoEventWireup="true" CodeFile="staffGrievanceOnStudent.aspx.cs" Inherits="login_staffGrievanceOnStudent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row">
                ...
                <h5>  <label for="no" style="color: #AFDA50;">Add Student Grievance:</label></h5>

                
                    <div class="row">
                        <div class="form-group col-md-8">
                            <label for="no" style="color: #33A0CC;">Grievance Message: *</label><asp:TextBox ID="TextBox1" runat="server" class="form-control" TextMode="MultiLine" placeholder="Enter Grievance"  required="required"></asp:TextBox>
           ...
           <div class="row">
                        <div class="form-group col-md-8">
                            <label for="pass" style="color: #33A0CC;"> Student Id: *</label>
