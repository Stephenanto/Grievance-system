<%@ Page Title="" Language="C#" MasterPageFile="~/login/MasterPage.master" AutoEventWireup="true" CodeFile="staffRegister.aspx.cs" Inherits="login_staffRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row">
                ...
                <h5>  <label for="no" style="color: #AFDA50;">Add Staff:</label></h5>
