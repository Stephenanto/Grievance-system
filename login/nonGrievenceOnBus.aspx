<%@ Page Title="" Language="C#" MasterPageFile="~/login/nonteach.master" AutoEventWireup="true" CodeFile="nonGrievenceOnBus.aspx.cs" Inherits="nonGrievenceOnBus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        ...
        <asp:Button ID="Button1" runat="server" class="btn btn-primary" OnClick="Button1_Click" Text="Add Grievence" />
    </div>
</asp:Content>
