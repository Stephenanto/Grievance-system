<%@ Page Title="" Language="C#" MasterPageFile="~/login/staffHomeMaster.master" AutoEventWireup="true" CodeFile="staffGrievanceOnStaff.aspx.cs" Inherits="login_staffGrievanceOnStaff" %>
...
<div class="row">
                ...
                <h5>  <label for="no" style="color: #AFDA50;">Add Staff Grievance:</label></h5>
           ...
           <div class="row">
                        <div class="form-group col-md-8">
                            <label for="pass" style="color: #33A0CC;"> Staff Id: *</label>
