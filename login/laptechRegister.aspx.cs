...
public partial class login_laptechRegister : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("INSERT INTO laptech_register VALUES(" + TextBox1.Text + ",'" + name + "','" + gender + "','" + address + "','" + phoneno + "','" + email + "','" + uname + "','" + password + "','"+lapname+"')", con);
