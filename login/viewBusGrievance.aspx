<%@ Page Title="" Language="C#" MasterPageFile="~/login/MasterPage.master" AutoEventWireup="true" CodeFile="viewBusGrievance.aspx.cs" Inherits="login_viewBusGrievance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:examConnectionString %>" DeleteCommand="DELETE FROM [bus_grievence] WHERE [grievenceid] = @grievenceid" InsertCommand="INSERT INTO [bus_grievence] ([grievencemessage], [grievencedate], [username], [userid]) VALUES (@grievencemessage, @grievencedate, @username, @userid)" SelectCommand="SELECT * FROM [bus_grievence]" UpdateCommand="UPDATE [bus_grievence] SET [grievencemessage] = @grievencemessage, [grievencedate] = @grievencedate, [username] = @username, [userid] = @userid WHERE [grievenceid] = @grievenceid">
        <DeleteParameters>
