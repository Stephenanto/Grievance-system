<%@ Page Language="C#" AutoEventWireup="true" CodeFile="staffLoginPage.aspx.cs" Inherits="login_staffLoginPage" %>
...
<body>
	<div class="container">
	  ...
	  <div class="row" id="marquee">
			<marquee scrolldelay="150"><asp:Label ID="Label3" runat="server" Font-Bold="true" ForeColor="#FB511D" Text="	.....Jain College....."></asp:Label></marquee>
	  </div>
        <div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="row" id="side2">
					<div class="row">
						<img alt="" src="images/keys.png" id="key">  Staff Login Page
					</div>
                    <div class="row">
						<form id="Form1" role="form" runat="server">
							...
							<div class="checkbox">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn btn-primary" OnClick="Button1_Click" />
                                  <a href="forgetpasswordStaff.aspx">forgot Password...?</a> <a href="../index.aspx" >Home</a>
        ...
        <asp:SqlDataSource ID="dsLogin" runat="server" ConnectionString="<%$ ConnectionStrings:examConnectionString %>"
            SelectCommand="select * from staff_register where  username = @lname and password = @pwd">
            <SelectParameters>
