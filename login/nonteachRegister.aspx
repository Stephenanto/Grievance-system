<%@ Page Title="" Language="C#" MasterPageFile="~/login/MasterPage.master" AutoEventWireup="true" CodeFile="nonteachRegister.aspx.cs" Inherits="login_nonteachRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="row">
                ...
                <h5>  <label for="no" style="color: #AFDA50;">Add Non Teaching Staff:</label></h5>
     ...
     ValidationExpression="^[0-9]*$" ValidationGroup="NumericValidate">*
                    ...
                    <div class="row">
                        <div class="form-group col-md-8">
                            <label for="fname" style="color: #33A0CC;">Work Place: *</label>



                            <asp:TextBox ID="TextBox8" runat="server" class="form-control"  placeholder="Enter Work Place"  required="required"></asp:TextBox>
