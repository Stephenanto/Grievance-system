	...
	<div class="container">
	  ...
	  <div class="row" id="marquee">
        ...
        <div class="row">
			...
			<div class="col-md-6">
				<div class="row" id="side2">
					<div class="row">
						<img alt="" src="images/keys.png" id="key"> Login Page
					</div>
                    <div class="row">
						<form id="Form1" role="form" runat="server">
							...
							<div class="checkbox">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="Login" CssClass="btn btn-primary" OnClick="Button1_Click" />
                                  <a href="forgetpassword.aspx">forgot Password....?</a>   <a href="../index.aspx" >Home</a>
        ...
        <asp:SqlDataSource ID="dsLogin" runat="server" ConnectionString="<%$ ConnectionStrings:examConnectionString %>"
            SelectCommand="select * from student_register where  username = @lname and password = @pwd">
            <SelectParameters>
