...
public partial class login_staffRegister : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("INSERT INTO staff_register VALUES(" + TextBox1.Text + ",'" + name + "','" + gender + "','" + department + "','" + address + "','" + phoneno + "','" + email + "','" + uname + "','" + password + "')", con);
