<%@ Page Title="" Language="C#" MasterPageFile="~/login/staffHomeMaster.master" AutoEventWireup="true" CodeFile="staffGrievanceOnEq.aspx.cs" Inherits="login_staffGrievanceOnEq" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <div class="row">
                ...
                <h5>  <label for="no" style="color: #AFDA50;">Add Equipments Grievance:</label></h5>
